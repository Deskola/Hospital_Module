        ...
        <div class="row">
            ...
            <!--Check for sucess message-->
                ...
                @foreach($patients as $patient)
                    <tr class="parent{{$patient->id}} table-hover">
                        ...
                        <td>
                            ...
                            <a href="#"
                                ...
                                id="edit_student"
                                data-id="{{$patient->national_id}}"
                                data-sur_name="{{$patient->sur_name}}"
                                data-first_name="{{$patient->first_name}}"
                                data-last_name="{{$patient->last_name}}"
                                data-dob="{{$patient->data_of_birth}}"
                                data-email="{{$patient->email}}"
                                data-residence="{{$patient->residential_area}}"                            
                            >Edit</a>
                        </td>
                        </tr>
                @endforeach
